...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, 
        ...
        # keep track of which episode and step this agent is on.  Only train on 
        # every n-th step
        self.episode = 0
        self.t = 0
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        # also... only learn every 20 steps
        # the learning every 20 steps was key to any learning happening...
        if (len(self.memory) > BATCH_SIZE) and ((self.t % UPDATE_EVERY) == 0):
            # sample and perform multiple updates to the networkafter new experience is gained.
    ...
    def learn(self, experiences, gamma):
        ...
        actor_loss.backward()
        torch.nn.utils.clip_grad_norm_(self.critic_local.parameters(), 1)  # clip_grad_norm_ deprecated
